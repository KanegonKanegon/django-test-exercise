...
class TodoViewTestCase(TestCase):
    ...
    def test_index_get_order_due(self):
        task1 = Task(title='task1', due_at=timezone.make_aware(datetime(2024, 7, 1)))
        task1.save()
        task2 = Task(title='tsak2', due_at=timezone.make_aware(datetime(2024, 8, 1)))
        task2.save()
        client = Client()
    ...
    def test__detail_get_success(self):
        task = Task(title='title1', due_at=timezone.make_aware(datetime(2024, 7, 1)))
        task.save()
        client = Client()
